...
function TestQuestionsPattern17() {
  ...
  const tests = {
    1: {
      ...
      questions: [
        {
          questionText: "1.	I consistently uphold ethical standards in all my interactions.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "2.	I avoid taking credit for others' work and ideas.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "3.	I follow company policies and guidelines, even when they seem unnecessary.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText: "4.	I communicate transparently and honestly with colleagues and clients.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "5.	I respect the confidentiality of sensitive information and avoid unauthorized sharing.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "6.	I take ownership of my mistakes and work to rectify them promptly.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "7.	I avoid situations that could lead to conflicts of interest and prioritize organizational interests.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "8.	I am committed to reporting any unethical behaviour I observe, regardless of the consequences.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "9.	I treat all individuals with fairness and respect, irrespective of their position.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
        {
          questionText:
            "10. I strive to maintain consistency between my personal values and professional conduct.",
          options: commonoption,
          optionWeightage: [1, 2, 3, 4, 5],
        },
      ],
  ...
  const testType = "Integrity Assessment";
...
export default TestQuestionsPattern17;
