...
5:{
  ...
  questions:[
    ...
    {
      questionText: "2. Which 3D shape has all its sides equal in length and all its angles equal?",
      options: [
    ...
    {
      questionText: "6. If you rotate a shape 90 ∘ clockwise, which direction will it be facing?",
      options: [
    ...
    {
      questionText: "7. Which 2D shape has four sides and four angles, where opposite sides are parallel and equal in length?",
      options: [
        { text: "A) Triangle", isCorrect: false },
        { text: "B) Circle", isCorrect: false },
    ...
    {
      questionText: "8. What do you call a line that divides a shape into two halves that are mirror images of each other??",
      options: [
    ...
    {
      questionText: "9. If you look at a cube from the top, what shape will you see?",
      options: [
        { text: "A) Triangle", isCorrect: false },
        { text: "B) Square", isCorrect: true },
        { text: "C) Circle", isCorrect: false },
    ...
    {
      questionText: "10. What is the term for the point where two rays meet to form an angle?",
      options: [
    ...
    {
      questionText: "11. In which of the four options is this cube shown from a different perspective?",
      options: [
        { text: "A" , isCorrect: true },
        { text: "B", isCorrect: false },
        { text: "C", isCorrect: false },
    ...
    {
      questionText: "12. If you rotate a shape by 180∘, what will its orientation be?",
      options: [
        { text: "A) Same as the initial orientation", isCorrect: false },
        { text: "B) 90∘ clockwise from the initial orientation", isCorrect: false },
        { text: "C) 90∘ counterclockwise from the initial orientation", isCorrect: false },
        { text: "D) Upside down from the initial orientation", isCorrect: true }
      ]
    },
    {
      questionText: "13. What is the term for a line that crosses two parallel lines, creating equal angles on either side?",
      options: [
        { text: "A) Perpendicular Line", isCorrect: false },
    ...
    {
      questionText: "15. If you reflect a shape over a vertical line, what type of symmetry does it have?",
      options: [
    ...
    {
      questionText: "16. Which 3D shape has a circular base and a curved surface that is not tapered to a point?",
      options: [
        { text: "A) Sphere", isCorrect: false },
        { text: "B) Cone", isCorrect: false },
    ...
    {
      questionText: "17. What is the term for the distance around the outside of a shape or object?",
      options: [
    ...
    {
      questionText: "18. Which term describes a 3D shape with all points equidistant from the centre?",
      options: [
    ...
    {
      questionText: "19. What is the term for a line that intersects two sides of a shape at right angles?",
      options: [
    ...
    {
      questionText: "20. What is the term for a straight path that goes on infinitely in both directions?",
      options: [
...
6:{
  ...
  questions:[
    {
      questionText: "1. If all roses are flowers and some flowers are red, which of the following statements must be true?",
      options: [
    ...
    {
      questionText: "2. The day before yesterday was Saturday. What day will it be the day after tomorrow?",
      options: [
    ...
    {
      questionText: "3. In the school midterm exams, David has lower marks than Dechen, but has more than Sonam. However, Karma also has more marks than David. Who has the lowest mark?",
      options: [
    ...
    {
      questionText: "5. If all cats have whiskers, and Felix is a cat, what can you conclude?",
      options: [
    ...
    {
      questionText: "8. Which of the following numbers comes next in the sequence: 2, 4, 8, 16, ...?",
      options: [
        { text: "A) 20", isCorrect: false },
        { text: "B) 24", isCorrect: false },
    ...
    {
      questionText: "9. A is the mother of B. B is the sister of C.  C is the father of D. So, how A is related to D?",
      options: [
    ...
    {
      questionText: "12. What will be the missing number in the series 196, 169, 144, __, 100, 81?",
      options: [
    ...
    {
      questionText: "13. Which letter comes next in the series: Z, Y, X, W, ...?",
      options: [
    ...
    {
      questionText: "14. Raman says “Anuj’s mother is the only daughter of my mother.” How is Anuj related to Raman?",
      options: [
    ...
    {
      questionText: "15. Which number should replace the question mark in the following series: 1, 4, 9, 16, ...?",
      options: [
    ...
    {
      questionText: "17. If all students like mathematics, and Jane is a student, what can you conclude?",
      options: [
    ...
    {
      questionText: "19. Which of the following numbers comes next in the sequence: 3, 6, 9, 12, ...?",
      options: [
    ...
    {
      questionText: "20. Marathon is to race as hibernation is to _______________",
      options: [
