        ...
        <>
          <div className="p-10">
            ...
            <p className="text-left font-semibold">
              <strong>Rarely: </strong>Assign a rating of 1 if the statement
              rarely applies to you.
            </p>
            <p className="text-left font-semibold">
              <strong>Occasionally: </strong> Assign a rating of 2 if the
              statement applies occasionally.
            </p>
            <p className="text-left font-semibold">
              <strong>Frequently: </strong> Assign a rating of 3 if the
              statement applies frequently.
            </p>
            <p className="text-left font-semibold">
