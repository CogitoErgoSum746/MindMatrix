...
function ParentingStyle({id}) {
    const subtests = [
        { id: 1, name: 'Authoritarian' },
        { id: 2, name: 'Authoritative' },
        { id: 3, name: 'Permissive' },
        { id: 4, name: 'Uninvolved' },
      ];
  ...
  return (
    ...
    <h1 className="text-2xl font-bold text-black mb-8 font-['Inter']">Parenting Style</h1>
