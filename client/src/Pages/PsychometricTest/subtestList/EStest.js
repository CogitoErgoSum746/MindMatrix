...
function EStest({id}) {
    const subtests = [
        { id: 1, name: 'Resilience' },
        { id: 2, name: 'Outlook' },
        { id: 3, name: 'Social Intuition' },
        {id: 4, name: 'Self-Awareness'},
        {id: 5, name: 'Sensitivity to Context'},
        {id: 6,name: 'Attention'}
      ];
  ...
  return (
    ...
    <h1 className="text-2xl font-bold text-black mb-8 font-['Inter']">Emotional Styles</h1>
