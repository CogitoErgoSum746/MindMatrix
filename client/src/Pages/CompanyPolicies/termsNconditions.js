            ...
            <div className="bg-gray-200">
                <div className="container mx-auto p-10 max-w-5xl text-left bg-white rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                        ...
                        constitute a binding agreement by and between SUCCESS STEPS NLP ACADEMY,
                        (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate
                        to your use of our website, goods (as applicable) or services (as applicable)
                        (collectively, “Services”).
                    </p>

                    <p className="mb-4">
                        By using our website and availing the Services, you agree that you have read and
                        accepted these Terms (including the Privacy Policy). We reserve the right to
                        modify these Terms at any time and without assigning any reason. It is your
                        responsibility to periodically review these Terms to stay informed of updates.
                    </p>

                    <h2 className="text-2xl font-bold mt-6 mb-2">The use of this website or availing of our Services is subject to the following terms of use:</h2>
                    ...
                    <ol className="list-decimal pl-6 mb-4">
                        <li>
                            ...
                            all acts done through the use of your registered account.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            to perform an obligation under these Terms if performance is prevented or delayed by a force majeure event.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            jurisdiction of the courts in B 1304, Raunak Paradise, Thane West, Maharashtra
                        </li>
                        <li>
