        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-16 lg:gap-48">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start">
              <a href="https://www.instagram.com/antony.k.a" target="_blank" className="text-blue-950 hover:text-blue-600">
                <svg
              ...
              <a href="https://www.facebook.com/Successteps7" target="_blank" className="text-blue-950 hover:text-blue-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
              ...
              <a href="https://www.youtube.com/@antonyaugusthy" target="_blank" className="text-blue-950 hover:text-blue-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
