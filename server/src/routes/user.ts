...
import { getUser, userDashboard, getTestResults, sendPdfToEmail, tektest, makeFinalPdf, checkScore, carreerOptions, checkSubscores, totalTests, multipleIRank } from '../controllers/UserController';
