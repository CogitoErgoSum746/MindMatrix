...
export const carreerSuggestions: FeedbackData = {
    ...
    "Multiple Intelligence": {
        "Linguistic": {
            "1-10": "Content Creator, Editorial Assistant, Copywriter, etc.",
            "11-20": "Content Writer, Social Media Manager, Freelance Writer, etc",
            "21-30": "Journalist, Public Relations Specialist, Author etc.",
            "31-40": "Linguist, Professor/Teacher, Diplomat/Translator, Novelist/Poet, Speechwriter, etc."
        },
        "Logical": {
            "1-10": "Data Entry Specialist, Accounting Clerk, Administrative Assistant, etc.",
            "11-20": "Junior Data Analyst, IT Support Specialist, Quality Assurance Tester, etc.",
            "21-30": "Data Scientist, Doctor, Software Developer, Financial Analyst, Operations Research Analyst, etc.",
            "31-40": "Doctor, Mathematician, Theoretical Physicist, Computing Scientist, Artificial Intelligence Researcher, etc."
        },
        "Spatial": {
            "1-10": "Designer, Artist, Graphic Design Assistant, etc.",
            "11-20": "Graphic Designer, Interior Designer, Photographer, Video Editor, etc.",
            "21-30": "Architect, Industrial Designer, Civil Engineer, etc.",
            "31-40": "Architectural Visualization Specialist, Industrial Design Manager, Fine Artist, 3D Modeler/Animator, Scientific Visualization Specialist, etc."
        },
        "Interpersonal": {
            "1-10": "Customer Service Representative, Team Coordinator, Entry-Level Management, etc. ",
            "11-20": "Human Resources Specialist, Counsellor or Therapist, Sales Representative, Middle Management, etc.",
            "21-30": "Leadership Positions, Coach or Mentor, Counsellor or Therapist, Community Organizer, etc. ",
            "31-40": "Psychologist, Executive Leadership, Diplomat, Leadership Coach, etc."
        },
        "Musical": {
            "1-10": "Music Educator, Music Blogger/Reviewer, Music Event Organizer, etc.",
            "11-20": "Music Teacher (Beginner Levels), DJ, Music Therapist Assistant, etc. ",
            "21-30": "Professional Musician, Music Teacher (Intermediate/Advanced Levels), Music Producer, etc.",
            "31-40": "Composer/Arranger, Music Conductor, Professional Musician (Solo Artist or Orchestra Member), etc."
        },
        "Kinesthetic": {
            "1-10": "Fitness Trainer/Instructor, Yoga Instructor, Recreational Sports Coach, Dance Enthusiast, etc.",
            "11-20": "Physical Therapist Assistant, Martial Arts Instructor, Circus Arts Performer, Parkour Instructor, etc.",
            "21-30": "Professional Athlete, Professional Dancer, Physical Education Teacher, Choreographer, etc.",
            "31-40": "Olympic Athlete,  Physical Therapy Specialist, Stunt Performer, etc."
        },
        "Intrapersonal": {
            "1-10": "Self-Help Writer, Administrative Assistant, Receptionist, etc.",
            "11-20": "Human Resources Specialist, Life Coach, Career Counsellor, etc. ",
            "21-30": "Psychologist, Leadership Coach, Motivational Speaker, etc.",
            "31-40": "Psychotherapist, Administrator, CEO, Spiritual Guide, etc."
        },
        "Naturalistic": {
            "1-10": "Nature Photographer, Park Ranger Assistant, Botanical Garden Intern, etc.",
            "11-20": "Environmental Educator, Wildlife Technician, Park Naturalist, etc.",
            "21-30": "Ecologist, Environmental Educator, Park Manager, etc.",
            "31-40": "Botanist, Wildlife Biologist, Environmental Consultant, Ecological Researcher, etc."
        }
    }
}
